...
/**
 * Ingest messages into conversations: resolve sender/recipient domains to
 * accounts, normalize, dedupe by (channel, subject, occurredAt) — skeleton
 * entity resolution is domain-match only, per docs.
 */
